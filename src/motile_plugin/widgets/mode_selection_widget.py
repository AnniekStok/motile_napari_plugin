...
from qtpy.QtWidgets     import QWidget, QVBoxLayout,QHBoxLayout, QGroupBox, QButtonGroup, QRadioButton
...
class SelectMode(QWidget):
    ...
    def __init__(self):
        ...
        selected_nodes_btn.clicked.connect(lambda: self._update_display('selection'))
